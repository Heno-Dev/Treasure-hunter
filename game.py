...
class Game: 
    ...
    def __init__(self):
        ...
        self.treasure = GameObject(388,50, 28, 28, 'assets/treasure.png')
    ...
    def reset_map(self):
        ...
        speed = 4 + (self.level * 2)

        if self.level >= 4.0:
            self.enemies = [
                Enemy(20, 600, 50, 50, 'assets/enemy.png', speed),
                Enemy(750, 200, 50, 50, 'assets/enemy.png', speed),
                Enemy(30, 400, 50, 50, 'assets/enemy.png', speed),
            ]
        elif self.level >= 2.0:
            self.enemies = [
                Enemy(20, 600, 50, 50, 'assets/enemy.png', speed),
